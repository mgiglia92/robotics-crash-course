...
#ifndef CU_SUMMER_STEM_ROBOTICS_CRASH_COURSE_SENSOR_ENCODER_H
#define CU_SUMMER_STEM_ROBOTICS_CRASH_COURSE_SENSOR_ENCODER_H
...
#endif /* CU_SUMMER_STEM_ROBOTICS_CRASH_COURSE_SENSOR_ENCODER_H */
